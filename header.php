<head>
 ...
 <div class="site-branding flex flex-column align-items-center">
                        <h1 class="site-title"><a href="" rel="home">LIBRARY</a></h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="site-branding flex flex-column align-items-center" font-size="medium">
                        <h4 class="site-title"><a href="<?php bloginfo('template_directory'); ?>/" rel="home">Find books,Magasin,CDs and more...</a></h4>
                    </div><!-- .site-branding -->
            ...
            <div class="col-12 col-lg-9">
                <div class="content-wrap">
                    <header class="entry-header">
                        ...
                        <h3 class="entry-title">Find books,Magasin,CDs and more...</h3>
